...
def index(request):
    ...
    if search_input:
        ...
        contacts = Contact.objects.all()
        search_input = ''
    return render(request, 'myApp/index.html', {'contacts': contacts, 'search_input': search_input})
...
def deleteContact(request, pk):
    ...
    return render(request, 'myApp/delete.html', {'contact': contact})

def contactProfile(request, pk):
    contact = Contact.objects.get(id=pk)
    return render(request, 'myApp/contact-profile.html', {'contact':contact})
